<script>
	...
	import CloseButton from "../aulas/CloseButton.svelte";
	import SalvarTreinamento from "../treinamentos/Salvar_treinamento.svelte";
...
<section>
	<button on:click={showPage}>Show a popup!</button>
	<br />
	<button on:click={showPopupLong}>Show a popup with long text!</button>
	<br />
	<button on:click={showPopupCustom}
		>Show a customized popup and listen to events!</button
	>
	<br />
